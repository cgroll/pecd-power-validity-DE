...
across ~/research/world-of-energy, ~/research/delu-headline-forecast, and
~/research/pecd-replication): a first call lists available block-start
timestamps, a second call fetches each block's actual observations.

Adapted from ~/research/pecd-replication/pecdr/smard.py, unchanged in
behavior -- kept as this project's own standalone copy rather than a
cross-repo dependency, since this download is small and self-contained.
"""
